...
While scrolling through the comments of one of the many i
This doesn't seem to provide a way to get the full path of the filename. –
Jason S
Sep 2, 2016 at 18:49
2
@JasonS: "the filename in the stack frame is relative to the start up directory of the application". –
unutbu
Sep 2, 2016 at 19:06
5
 and an option run the scoring system locally. Scoring worked as follows:
