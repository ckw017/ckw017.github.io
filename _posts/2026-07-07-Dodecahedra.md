...
Don't tell anyone, but despite majoring in Computer <i>Science</i> and Data <i>Science</i> at Berkeley's College of
Letters and <i>Sciences</i> I somehow ended up with a Bachelor of
$${\color{#dd2222}\mathcal{A}}{\color{#dd8800}\mathfrak{r}}{\color{#00aa00}\mathfrak{t}}{\color{#0000ff}\mathfrak{s}}$$. Anyway, it was thanks to
a required art class that I encountered [*Incomplete Open Cubes*](https://www.sfmoma.org/artwork/97.516.A-KKKKKKKKKK/) by Sol LeWitt at
